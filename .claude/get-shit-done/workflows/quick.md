...
```bash
INIT=$(node "C:/Users/PatrickSheehy/Desktop/Stride Project/.claude/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "C:/Users/PatrickSheehy/Desktop/Stride Project/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
