...
- [x] **ARCH-02**: App functions as an offline-capable PWA with service worker and app manifest
- [x] **ARCH-03**: Scoring pipeline runs in a Web Worker to prevent UI blocking during route generation
